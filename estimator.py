...
def map_path_ekf(x0, h_func_select='h_rss', bplot=False, blog=False, bprintdata=False,bprintRCtime=False, save_EKF_data=True):
    ...
    tx_freq = [434.00e6, 434.30e6, 434.15e6, 434.45e6, 434.65e6, 433.90e6]
    ...
    # initialization for bprinttime and Save data
    n = 0
    import time
